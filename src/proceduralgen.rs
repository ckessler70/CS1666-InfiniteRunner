    ...
    */
    ...
    pub fn gen_terrain(
        ...
        let terrain = TerrainSegment::new(
            ...
            terrain_type,
            color,
            (curve_points.1 .1 .0 as i32, curve_points.1 .1 .1 as i32),
            (curve_points.1 .2 .0 as i32, curve_points.1 .2 .1 as i32),
        );
...
fn gen_bezier_curve(
    ...
    point_mod_3: (f64, f64),
    buffer: i32,
) -> (Vec<(i32, i32)>, ((f64, f64), (f64, f64), (f64, f64))) {
    ...
    return (group_of_points, (p0, p1, p2));
}
